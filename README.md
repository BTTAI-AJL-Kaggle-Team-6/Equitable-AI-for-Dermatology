...
| ----- | ----- | ----- |
| Noam Reiner | @noamreiner17 | Team Captain. Managed team communication and progress tracking. Contributed to README updates, setting up the initial model and model accuracy improvements. |
